...
def SMNet34(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet34-333f7ec4.pth
    return SMNet(BasicBlock, [3, 4, 3, 3], num_classes=num_classes, include_top=include_top)


def SMNet50(num_classes=1000, include_top=True):
    # https://download.pytorch.org/models/resnet50-19c8e357.pth
    return SMNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, include_top=include_top)
